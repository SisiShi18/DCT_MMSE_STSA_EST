...
default_opt = 'normal';
valid_opt = {'norm','lap','gamma','cauchy','laplace','normal','gauss'};
check_opt = @(x) any(validatestring(x,valid_opt));
...
%                         gain = CSA_g(xi_hat,gamma_k);
                    ...
                    case {'cauchy'}
                        [xi,gamma_k] = est_xi_norm(noisy_pow(n,:),noise_pow(n,:),xi_min,alpha4,n,clean_est_frame);
                        
                        gain = CSA_cauchy(xi,gamma_k);
